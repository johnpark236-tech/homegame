...
const tigerImages = {
  idle: '/assets/characters/tiger-idle.png',
  run: '/assets/characters/tiger-run.png',
  win: '/assets/characters/tiger-win.png',
};
...
export const BabyTiger: React.FC<CharacterProps> = ({
  ...
  return (
    <div
      ...
      aria-label="아기 호랑이 캐릭터"
    >
      <img
        src={tigerImages[activeVariant]}
        alt=""
        draggable={false}
